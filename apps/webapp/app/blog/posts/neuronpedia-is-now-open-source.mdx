...
imagePreview: /images/blog/neuronpedia-is-now-open-source-preview.gif
---
...
- Reach out to us via [Slack #neuronpedia](https://join.slack.com/t/opensourcemechanistic/shared_invite/zt-2o756ku1c-_yKBeUQMVfS_p_qcK6QLeA), [email](mailto:johnny@neuronpedia.org), or [GitHub Issues](https://github.com/hijohnnylin/neuronpedia/issues)
...
For example, with a [single prompt](https://github.com/hijohnnylin/neuronpedia/blob/main/apps/experiments/steerify/README.md#claude-code-prompt) to Claude Code, it builds a new app "Steerify" using Neuronpedia components, with no intervention or fixes. Here's the entire workflow from start to end:
![Video of Steerify](https://neuronpedia-datasets.s3.us-east-1.amazonaws.com/steerify-shrink.mp4)
...
![Video of using instant deploy](https://neuronpedia-datasets.s3.us-east-1.amazonaws.com/puppyneurons-shrink.mp4)
