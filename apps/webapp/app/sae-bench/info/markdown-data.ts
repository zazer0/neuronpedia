...
Follow-up work by [Chaudhary & Geiger](https://github.com/MaheepChaudhary/SAE-Ravel) adapted the RAVEL benchmark to sparse autoencoders. While our implementation is closely related to the original RAVEL evaluation, a differential binary masking-based latent selection in line with [Chaudhary & Geiger](https://github.com/MaheepChaudhary/SAE-Ravel) is forthcoming. RAVEL is not featured on Neuronpedia, yet.
</details>
