...
class CacheBenchmark:
    ...
    def benchmark_activation_all(self, iterations: int = 5):
        ...
        payload = {
            ...
            "model": self.model,
            "source_set": "res-jb",
            "selected_sources": ["0-res-jb", "2-res-jb", "4-res-jb", "6-res-jb", "8-res-jb"],
            "num_results": 20,
    ...
    def benchmark_activation_single(self, iterations: int = 5):
        ...
        prompt = "Machine learning models have revolutionized natural language processing"
        ...
        for layer in layers:
            ...
            for i in range(iterations):
                ...
                if success:
                    ...
                    console.print(f"    Run {i+1}: {elapsed*1000:.2f}ms {cache_indicator}")
    ...
    def benchmark_mixed_pattern(self):
        ...
        for i, (endpoint, payload) in enumerate(sequence):
            ...
            if success:
                ...
                console.print(f"  {endpoint:<25} {elapsed*1000:>8.2f}ms [{cache_status}]")
    ...
    def print_summary(self):
        ...
        if cache_stats:
            ...
            console.print(f"  Cache Size: {cache_stats.get('size', 0)}/{cache_stats.get('max_size', 5)}")
        ...
        for endpoint, times in self.results.items():
            if len(times) >= 2:
                output["summary"][endpoint] = {
                    ...
                    "improvement_percent": (times[0] - statistics.mean(times[1:])) / times[0] * 100,
...
def main():
    parser = argparse.ArgumentParser(description="Benchmark layer activation cache performance")
